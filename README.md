...
- 2FA is so annoying
- Main projects are Horizons (a dynamic vanilla+ add-on for Bedrock platforms, formerly Expanding Wilderness, see the repo [ex-wi](https://github.com/PhoenixAsh89/ex-wi); repo upcoming) and Horizon's Edge (A Vibrant Visuals texture pack to accompany Horizons; repo upcoming)
